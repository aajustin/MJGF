...
def get_log_dir(device, air):
    """"
        在 .air/log/ 文件夹下创建每台设备的运行日志文件夹
        Create log folder based on device name under .air/log/
    """
...
if __name__ == '__main__':
    ...
    ap = []
    root_dir = os.getcwd()#获取当前文件路径
    #print(root_dir)
    #root_dir = 'G:\\AirtestIDE_2019-01-15_py3_win64\\multi-device-runner'
    #获取当前路径下【.air】文件
